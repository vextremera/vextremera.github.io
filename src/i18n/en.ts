		...
		items: [
			{
				...
				problem:
					'A bar-restaurant that wants to sell online needs rather more than a PDF menu: a catalogue with allergens, products you can configure to taste, orders for pickup or delivery, and someone on the staff who can change prices, opening hours or coupons without touching code. ARCADIA covers that whole journey, from the public menu to the kitchen screen.',
				contribution:
					'The entire project, from the database schema to the last button: 149 of its 150 commits are mine. The public front end, with a cart that survives the session and a checkout that validates availability and coupons before letting you pay. A step-by-step product configurator for removing base ingredients and adding extras and sauces. And a back office of eighteen areas — catalogue, allergens, compatibilities, modifiers, opening hours, payment methods, coupons, upsell, loyalty, kitchen and audit, among others — so the business does not depend on me to operate. Underneath, Astro DB for the schema, Redis for sessions in production and blob storage for product images.',
				outcome:
					'It sits at an advanced, working version: you can order end to end and administer all of it from the panel. Three things stand between it and production, and I know which: the seeding strategy for the remote database — the current seed is destructive and must stay away from real data — hardening the deploy, and a full smoke test of buying and administering. [One or two sentences of your own: what building it taught you and what you would do differently today.]',
